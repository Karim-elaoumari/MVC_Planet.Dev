...
<form   method="post"  action="" class="modal-body bg-white p-2 p-sm-5 " style="border-radius:5px" enctype='multipart/form-data'>
<div id="article-form">
<hr>
  <div class="row">
  ...
  <div class="form-group col-3" >
        ...
        <select name="categorie" class="form-control" id="categorieEdit"  >
  ...
  <div class="form-group col-3 mt-2">
    ...
    <input type="file" class="form-control"  accept="image/png, image/jpeg, image/jpg" name="coverEdittt"  >
  </div>
  </div>
